...
void GraphicsPipelineManager::SetRootSignature(const std::string& key)
{
    // パイプラインステートの存在確認
...
void GraphicsPipelineManager::SetPipeline(const std::string& key)
{
    // パイプラインステートの存在確認
    if (pipelineStates_.find(key) == pipelineStates_.end()) {
        // 存在しない場合は作成
...
void GraphicsPipelineManager::CreateRootSignature(const std::string& key)
{
}

void GraphicsPipelineManager::CreatePipelineState(const std::string& key)
{
    // パイプラインステートの設定を構築
...
void GraphicsPipelineManager::CRS_Sprite()
{

}

void GraphicsPipelineManager::CRS_Object()
{
}

void GraphicsPipelineManager::CRS_Line()
{
}

void GraphicsPipelineManager::CGP_Sprite()
{
}

void GraphicsPipelineManager::CGP_Object()
{
}

void GraphicsPipelineManager::CGP_Line()
{
}
